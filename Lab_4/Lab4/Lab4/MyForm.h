...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"MV Boli", 10.2F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(19, 102);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(382, 132);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Äëÿ çì³íè êîëüîğó òåêñòó íàæì³òü íà\r\n\"Êîë³ğ - Òåêñò\"\r\nàáî ïğàâîş êëàâ³øåş íà ìåíå"
				L"\r\n\r\nÄëÿ çì³íè ôîíó íàæì³òü íà \"Êîë³ğ - Ôîí\"\r\nàáî íà ïóñòèé õîëñò ïğàâîş êëàâ³øåş"
				L" ";
			// 
			// contextMenuStrip1
			// 
			...
			this->ñèí³éToolStripMenuItem2->Click += gcnew System::EventHandler(this, &MyForm::ñèí³éToolStripMenuItem_Click);
			// 
			// menuStrip1
			// 
			...
			this->menuStrip1->Size = System::Drawing::Size(413, 28);
			...
			this->ñèí³éToolStripMenuItem3->Click += gcnew System::EventHandler(this, &MyForm::ñèí³éToolStripMenuItem1_Click);
			// 
			// MyForm
			// 
